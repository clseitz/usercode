...
void make_asym()
{
  ...
  filelist.push_back(TFile::Open("../TTBar_plots.root"));
  ...
  filelist.push_back(TFile::Open("../WJets_plots.root"));
  namelist.push_back("TTbarJEts_e");
  //nEvtTot.push_back(216095.0);
  nEvtTot.push_back(3.6838e+06);
  McXsec.push_back(0);
  ...
  */
  ...
  filelist.push_back(TFile::Open("../Wp600_plots.root"));
 ...
 //VarList.push_back("TransMassLepMET4Jet_vs_LeadingJetPt_");
  ...
  TFile fnew1("asym_plots.root", "recreate");
  ...
  for(int i=0; i<(plotlist.size()); i++){//loop for all the plots we wan to
