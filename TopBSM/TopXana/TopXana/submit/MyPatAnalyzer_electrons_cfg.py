...
print sys.argv[2]
suffix_list=[]
suffix_list.append("DataSingleElv4_166554")
suffix_list.append("DataSingleElv1v2_May10_42X")


this_fin  = "TopBSM.TopXana.DataSingleElv1v2v4_"+sys.argv[2]+"_cfi"

this_fout0 = "/cms/data21/clseitz/CMS_leptons/Electrons/NewCode2/Electrons_"+sys.argv[2]+".root"
this_fout1 = "/cms/data21/clseitz/CMS_leptons/Electrons/NewCode2/Electrons_tree_"+sys.argv[2]+".root"

print "Electrons_"+sys.argv[2]+"file"
