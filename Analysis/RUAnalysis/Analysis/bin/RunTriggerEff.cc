...
int RunTriggerEff (std::vector<TString>& InFileNames, bool const IsData, TString const OutFileName)
{
  NtpTriggerEff Ana(InFileNames, IsData, OutFileName);
...
int main (int argc, char* argv[])
{
  ...
  RunTriggerEff(InFileNames, IsData, OutFileName);
