...
%%Personally, I think it will be better to show both Fig. 6 plots with the acceptance x efficiency uncertainties
%%associated to them. This dip should be evaluated within that context, and it's hard to judge the importance
%%of this effect without it. For the moment, we can remain vague in the text.
