...
#        hist_data2.Sumw2();
        ...
        # hist_rpv250 =  rpv250.Get(histname);
...
# #        hist_Zprime1250 =  Zprime1250.Get(histname);
        ...
        if (false and logscale == 0):
          ...
          if (numevts > 0):
            ...
            # numevts = hist_rpv250.Integral();
            # hist_rpv250.Scale(1.0/numevts);
...
#                hist_qcd.Scale(nqcd/hist_qcd.Integral())
        ...
        if ("nBJet35_EvtSel" in histname):
            ...
            hist_data.SetXTitle("1st Jet pT");
            hist_data.SetYTitle("Events");
            rebin = 2;
            Urange = (0, 400)
        elif ("Jet3" in histname):
            hist_data.SetXTitle("3rd Jet pT");
            hist_data.SetYTitle("Events");
            rebin = 2;
            Urange = (0, 300)
        ...
        if ('jet1' in histname):
                  ...
                  # hist_rpv250.SetAxisRange(Urange[0], Urange[1]);
...
#
        ...
        hist_rpv200.SetLineColor(kGray + 1);
        hist_rpv200.SetLineWidth(linewidth);
        if ("Mjjj_1btag" in histname):
          hist_nobtags.SetLineColor(kRed + 1);
          hist_anybtags.SetLineColor(kGreen + 1);

        # hist_rpv250.SetLineColor(kCyan);
        # hist_rpv250.SetLineWidth(linewidth);
...
#        qcdUncert.SetFillStyle(3003);
        ...
        # leg.AddEntry(hist_stsusy300, "StealthSUSY 300", "L");
...
#        leg.AddEntry(hist_Zprime1250, "Z' 1.25TeV");
        ...
        if ('jet1' in histname):
          ...
          if ("Mjjj_1btag" in histname):
            if hist_nobtags.GetMaximum() > max :
              max = hist_nobtags.GetMaximum() * 1.1
...
#           if hist_wpm400.GetMaximum() > max :
        ...
        if ("Mjjj_bjet" in histname):
          hist_nobtags = hist_rpv200.Clone("test");
        elif ("Mjjj_btag" in histname):
          hist_anybtags = hist_rpv200.Clone("test");
...
#        hist_Zprime1250.Draw("same");
        ...
        # cu_hist_rpv250 = getCumulativePlot(hist_rpv250, "rvp250");
...
#
        ...
        # cu_hist_rpv250.SetAxisRange(Urange[0], Urange[1]);
        ...
        if (Yrange[1] > 0):
            ...
            # cu_hist_rpv250.SetAxisRange(Yrange[0], Yrange[1], "Y");
