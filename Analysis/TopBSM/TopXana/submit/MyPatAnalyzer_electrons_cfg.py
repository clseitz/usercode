...
this_fout0 = "/cms/data21/clseitz/CMS_leptons/Electrons/NewCode4/Electrons_"+sys.argv[2]+".root"
this_fout1 = "/cms/data21/clseitz/CMS_leptons/Electrons/NewCode4/Electrons_tree_"+sys.argv[2]+".root"
...
process.data2 = cms.EDAnalyzer('TopXana',
  ...
  jetptcut       = cms.untracked.double(20.0),
