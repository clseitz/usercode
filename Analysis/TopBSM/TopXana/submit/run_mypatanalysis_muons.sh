...
export MYSCRIPT=/users/h1/clseitz/MyCMS/CMSSW_4_2_4/src/TopBSM/TopXana/submit/MyPatAnalyzer_muons_cfg.py
...
cmsRun $MYSCRIPT $process >& /cms/data21/clseitz/CMS_leptons/Muons/NewCode4/log/Muons_TopXanaPlots_${process}.log
