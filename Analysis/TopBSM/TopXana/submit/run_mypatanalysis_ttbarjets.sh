...
export MYSCRIPT=/users/h1/clseitz/MyCMS/CMSSW_4_2_4/src/TopBSM/TopXana/submit/MyTopXana_ttbarjets_cfg.py
...
cmsRun $MYSCRIPT $process >& /cms/data21/clseitz/CMS_leptons/TTbarJets/log/TTbarJets_TopXanaPlots_${process}.log
